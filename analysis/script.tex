...
%[Hint: it may be useful to show that each metric is associated to a norm which satisfies
%the analogous properties of Proposition~\ref{P:abs_props} (except (iii), which does not make sense here).]
\label{X:Rn_metric}
\end{ex}
